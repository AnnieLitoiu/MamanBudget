...
function showEvent() {
  ...
  const choicesContainer = document.getElementById('choix');
...
function showBilan(bilan) {
  ...
  eventText.textContent = "Bilan de la semaine : " + bilan;
  choicesContainer.innerHTML = "";  // Réinitialiser les choix
  ...
  if (data.weeks[`week${currentWeek}`]) {
    ...
    eventText.textContent = "Le jeu est terminé. Félicitations !";
  }
}
