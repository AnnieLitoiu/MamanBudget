 ...
 */
final class Version20251111103232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE situation (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, nb_enfants INT NOT NULL, revenu_mensuel INT NOT NULL, logement VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_EC2D9ACAFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
